...
class Gallery
{
    ...
    public function registerAssets()
    {
        ...
        Theme::asset()
            ->container('footer')
            // ->add('jquery-js', 'themes/e-commerce/assets/css/wp-includes/js/jquery/jquery.min.js', ['jquery'])
            ...
            ->add('jquery-js', 'themes/e-commerce/assets/vendor/jquery/jquery.min.js')
