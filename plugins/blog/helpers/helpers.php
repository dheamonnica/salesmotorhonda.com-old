...
if (!function_exists('getByCategoryNews')) {
    /**
     * @param $current_slug
     * @param $limit
     * @return mixed
     * @author Sang Nguyen
     */
    function getByCategoryNews($current_slug, $limit)
    {
        return app(PostInterface::class)->getByCategoryNews($current_slug, $limit);
    }
}

if (!function_exists('getByCategoryExNews')) {
    /**
     * @param $current_slug
     * @param $limit
     * @return mixed
     * @author Sang Nguyen
     */
    function getByCategoryExNews($current_slug, $limit)
    {
        return app(PostInterface::class)->getByCategoryExNews($current_slug, $limit);
    }
}
